...
class Db_object {
    ...
    public function create(){
        ...
        //TODO implode elements without id!!!!!!!!!!!! echo join(' ', array_slice($word, 2, 2));

        $sql="INSERT INTO ". static::$db_table ."(".  implode(",", array_slice(array_keys($properties),1)) .")";
        $sql.=" VALUES ('".  implode("','",array_slice(array_values($properties),1)) ."')";
